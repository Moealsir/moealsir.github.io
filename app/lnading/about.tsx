...
export default function About() {
    ...
    return (
        <div>
            <div className="px-4 pt-16 mx-auto sm:max-w-xl md:max-w-full lg:max-w-full md:px-24 lg:px-24">
  <div className="grid gap-10 row-gap-6 mb-8 sm:grid-cols-2 lg:grid-cols-4">
    <div className="sm:col-span-2">
      ...
      <div className="mt-6 lg:max-w-sm">
        ...
        WeatherWave is committed to delivering the most reliable weather information to help you stay prepared for any conditions. Our mission is to provide comprehensive and precise weather data to keep you informed and safe. We leverage cutting-edge technology and expert analysis to ensure our forecasts are accurate and timely. Whether you’re planning your day, your week, or a specific event, WeatherWave has you covered.
        </p>
      </div>
    </div>
    <div className="space-y-2 text-sm">
      ...
      <div className="flex">
        ...
        <a href="tel:850-123-5021" aria-label="Our phone" title="Our phone" className="transition-colors duration-300 text-deep-purple-accent-400 hover:text-deep-purple-800">+97439900342</a>
      </div>
      <div className="flex">
        <p className="mr-1 text-gray-800">Email:</p>
        <a href="mailto:info@lorem.mail" aria-label="Our email" title="Our email" className="transition-colors duration-300 text-deep-purple-accent-400 hover:text-deep-purple-800">info@moealsir.tech</a>
      </div>
      <div className="flex">
    ...
    <div>
      ...
      Stay connected with us on social media for the latest weather updates and more.
      </p>
    </div>
  </div>
